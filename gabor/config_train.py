...
C.repo_name = 'FB_flatcam'


"""Data Dir and Weight Dir"""
C.dataset_path = "~/FB_flatcam"
...
C.pretrain = False
# C.pretrain = 'ckpt/100-6-gabor/weights_599.pt'
# C.pretrain = 'ckpt/pretrain'


C.extract = False
C.num_images = 100
C.save_path = './10-6-gabor-act-100/'
...
C.save = "finetune-100-6-gabor-0.9-max"
C.std = 0.9
C.std_use = "max"
########################################
...
if C.pretrain == True:
    ...
    C.load_path = 'ckpt/finetune-10-2-20200512-134912'
